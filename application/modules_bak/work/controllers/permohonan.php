...
class Permohonan extends CI_Controller {
	...
	public function pdf($id, $download = 0,$header = 0)
	{
		...
		$content = $this->load->view("permohonan_pdf",array("data" => $main_data,"setting" => $setting),true);
                ...
                <td>
        				...
        				<td>
							...
							<tr class="master_detail2" style="border-bottom:2px solid black;">
								...
								<td colspan="3"><a href="javascript:void(0)" class="btn btn-small paket_btn btn-success" data-pos="0"> Pilih Paket</a></td>
							</tr>
