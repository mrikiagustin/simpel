...
Begin VB.Form frmLaporan 
   ...
   Begin MSAdodcLib.Adodc AdoParameter 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT Parameter_Uji FROM parameter WHERE Jenis_Pengujian='Benih' ORDER BY Parameter_Uji ASC;"
      Caption         =   "Adodc3"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      ...
      BeginProperty Column08 
         ...
         Caption         =   "Metode Uji / Analytical Methods"
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            Type            =   0
            Format          =   ""
            HaveTrueFalseNull=   0
...
Dim prvLaporan As New rptLaporan
prvLaporan.Show vbModal
End Sub
...
Adodc2.Refresh
DataGrid1.Refresh
AdoParameter.RecordSource = "SELECT Parameter_Uji FROM parameter WHERE Jenis_Pengujian='" & Adodc1.Recordset!Jenis_Laporan & "' ORDER BY Parameter_Uji ASC"
AdoParameter.Refresh
ListIndex = 2
