...
Begin VB.Form frmLaporanF 
   ...
   Begin MSAdodcLib.Adodc AdoParameter 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT Parameter_Uji FROM parameter WHERE Jenis_Pengujian='Formulasi' ORDER BY Parameter_Uji ASC;"
      Caption         =   "AdoParameter"
...
Dim prvLaporanF As New rptLaporanF
prvLaporanF.Show vbModal
End Sub
